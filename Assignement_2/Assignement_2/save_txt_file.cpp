...
//	{
//		const CVertex& v = graph[i];
//		for (size_t n = 0; n < v.neighbours.size(); ++n)
//		{
//			CVertex* nv = v.neighbours[n];
...
//template<typename T>
//void CSaveGraph::collect_labels(const vector<T>& graph, vector<pair<string, pair<size_t, size_t>>>& out_labels) const
//{
